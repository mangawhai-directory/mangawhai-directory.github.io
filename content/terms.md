...
Nothing in these Terms is intended to limit or exclude any rights you may have as a consumer under the [Consumer Guarantees Act 1993](https://www.legislation.govt.nz/act/public/1993/0091/latest/DLM311053.html) or the [Fair Trading Act 1986](https://www.legislation.govt.nz/act/public/1986/0121/latest/whole.html), where those rights cannot lawfully be excluded.
...
- **"Premium Listing"** means the upgraded business listing described on the [advertise page](/advertise/) (image/logo, blurb, opening hours) added to your free directory entry.
...
- **The founding price hold.** If you are one of those ten, we will honour your founding rate for **any booked month falling within 12 months of your first go-live date** — including after founding rates have closed to everyone else, and including if the published rate card has moved up a step in the meantime. Those months do **not** have to be consecutive; a seasonal advertiser who books only over summer keeps the rate. Booked months falling outside that 12-month window are charged at the rate published when you book them.
- **What happens after that.** Once the hold ends, the then-current published rate applies. We will tell you the date your hold ends **when you make your first Booking**, and we will tell you the current rate **before you rebook** — so a price change never reaches you for the first time on an invoice.
...
- You must supply Material that meets the size, file format, and content guidelines on the [advertise page](/advertise/), and the click-through URL must be accurate and active.
- We may, in our reasonable discretion, **refuse to publish, request changes to, or remove** any Material that:
  - breaches the [Advertising Standards Authority (ASA) Codes](https://asa.co.nz/codes/);
...
How we handle personal information is set out in our [Privacy Policy](/privacy/).
...
These Terms are governed by the laws of New Zealand. Each party submits to the non-exclusive jurisdiction of the New Zealand courts. Claims within the jurisdictional limit may also be brought in the [Disputes Tribunal of New Zealand](https://www.justice.govt.nz/tribunals/disputes-tribunal/).

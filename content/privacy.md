...
You can opt out of Google Analytics on every site you visit by installing the [Google Analytics Opt-out Browser Add-on](https://tools.google.com/dlpage/gaoptout). You can also disable cookies in your browser settings — analytics cookies do not affect site function.
...
- **Strictly necessary** — none. The directory is a static site that does not require cookies to function.
- **Analytics** — set by Google Analytics 4 (`_ga`, `_ga_*`).

We do not use advertising or tracking cookies beyond GA4. Most browsers let you block, delete or restrict cookies; doing so will not affect your ability to use the directory.
...
We take reasonable steps to protect personal information against loss, unauthorised access, modification, disclosure or other misuse, in line with [IPP 5](https://www.privacy.org.nz/privacy-principles/5/). The site is served over HTTPS; access to administrative tools is restricted; supplier contracts include security obligations.

In the event of a serious privacy breach (a "notifiable breach" under Part 6 of the Privacy Act 2020), we will notify the Office of the Privacy Commissioner and any affected individuals as soon as practicable.
...
- **Correct** information you believe is inaccurate or incomplete (IPP 7).
- **Request deletion** of information we hold about you. We'll do that unless we're legally required to retain it.

To exercise any of these rights, email us at the contact details below. We'll respond within **20 working days**, as required by the Act. We may ask for proof of identity before releasing or changing personal information.

## Children

This site is intended for a general adult audience (business listings). We do not knowingly collect personal information from children under 16. If you believe a child has supplied personal information through our contact form, please contact us and we will delete it.

## Changes to this policy

We may update this policy from time to time. Material changes will be flagged at the top of the page; the "Last updated" date above always reflects the current version.
...
- **Web:** [privacy.org.nz/your-rights/making-a-complaint](https://www.privacy.org.nz/your-rights/making-a-complaint/)
- **Phone:** 0800 803 909
